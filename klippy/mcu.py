...
class MCURestartHelper:
    def __init__(self, config, conn_helper):
        ...
        # Restart tracking
        restart_methods = [None, 'arduino', 'cheetah', 'command', 'rpi_usb', 'rts']
    ...
    def lookup_attach_uart_rts(self):
        ...
        return not ((self._restart_method == "cheetah") or (self._restart_method == "rts"))
    ...
    def _restart_rts(self):
        ...
        self._disconnect()
        serialport, baud = self._conn_helper.get_serialport()
        serialhdl.rts_reset(serialport, self._reactor)
